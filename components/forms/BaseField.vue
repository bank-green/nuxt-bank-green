  ...
  <div class="relative">
    ...
    >
      ...
      >
        ...
        <span
          v-if="infoTooltipShown"
          class="absolute text-xs p-2 rounded-lg bg-primary-dark z-50 text-white w-24 md:w-32 left-8 -top-2"
        >
          {{ infoTooltip }}
        </span>
      </div>
