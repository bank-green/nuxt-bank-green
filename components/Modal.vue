<template>
    <transition
        ...
        <div class="fixed inset-0 flex justify-center items-center backdrop-blur p-0 z-50">
            <div class="relative bg-primary-dark flex items-center justify-center h-screen w-full max-h-screen overflow-auto">
                <div
