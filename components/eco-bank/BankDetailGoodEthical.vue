<template>
    <div class="page">
        <div class="contain py-16 lg:pt-6 lg:pb-6 sm:text-center">
            ...
            <NuxtLink :to="`https://data.bank.green/update/${details.tag}`" target="_blank" class="relative z-10 cursor-pointer text-center text-slate-600 hover:underline">Tell us if we got something wrong</NuxtLink>
        </div>
