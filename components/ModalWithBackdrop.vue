<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="absolute top-0 flex flex-col items-center justify-center mt-28 mb-20 sm:px-6 md:px-8 lg:px-10 text-gray-50 text-center bg-sushi-100 rounded-2xl max-md:px-5 w-3/4 h-3/4"
          @click.prevent.stop=""
        >
          <div class="flex flex-row items-center justify-center text-black w-full">
            <div

              class="relative w-full justify-between items-stretch self-stretch flex gap-5 mt-10 max-md:max-w-full max-md:flex-wrap max-md:mt-10"
            >
              <div
                v-if="title"
