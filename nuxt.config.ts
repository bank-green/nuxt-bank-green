...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      ZAPIER_SEND: process.env.ZAPIER_SEND_CONTACT,
      ZAPIER_UNSUBSCRIBE: process.env.ZAPIER_UNSUBSCRIBE,
      ACTIVE_CAMPAIGN_SECRET: process.env.NUXT_PUBLIC_ACTIVE_CAMPAIGN_SECRET,
