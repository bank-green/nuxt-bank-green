    ...
    <div class="page">
        <div class="bg-sushi-50">
            <div class="page-fade-in contain pt-28 pb-16">
                <article class="prose-h1:text-2xl prose-h1:font-semibold prose-p:leading-10 prose-p:text-gray-600 ">
                    <SliceZone :slices="press?.data.slices ?? []" :components="sliceComps" />
                </article>
